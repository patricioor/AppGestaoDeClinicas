...
namespace GeCli.Back.Domain.Test
{
    public class CustomerUnitTest
    {
        ...
        {
            Action action = () => new Customer(1, "New Customer", "New Address", "85123456789", "01012001");
            action.Should()
        ...
        {
            Action action = () => new Customer(1, null, "New Address", "85987654321", "01012001");
            action.Should()
                .Throw<Validation.DomainExceptionValidation>();
        }
        ...
        {
            Action action = () => new Customer(1, "Ne", "New Address", "85987654321", "01012001");
            action.Should()
                .Throw<Validation.DomainExceptionValidation>();
        }
        ...
        {
            Action action = () => new Customer(1, "New Customer", null, "85987654321", "01012001");
            action.Should()
                .Throw<Validation.DomainExceptionValidation>();
        }
        ...
        {
            Action action = () => new Customer(1, "New Customer", "New AddressNew AddressNew AddressNew AddressNew AddressNew AddressNew AddressNew AddressNew AddressNew AddressNew AddressNew AddressNew AddressNew AddressNew AddressNew AddressNew AddressNew AddressNew AddressNew Address", "85987654321", "01012001");
            action.Should()
                .Throw<Validation.DomainExceptionValidation>();
        }
        ...
        {
            Action action = () => new Customer(1, "New Customer", "NewA", "85987654321", "01012001");
            action.Should()
                .Throw<Validation.DomainExceptionValidation>();
        }
        ...
        {
            Action action = () => new Customer(1, "New Customer", "New Address", null, "01012001");
            action.Should()
                .Throw<Validation.DomainExceptionValidation>();
        }
        ...
        {
            Action action = () => new Customer(1, "New Customer", "New Address", "5987654321", "01012001");
            action.Should()
                .Throw<Validation.DomainExceptionValidation>();
        }
        ...
        {
            Action action = () => new Customer(1, "New Customer", "New Address", "085987654321", "01012001");
            action.Should()
                .Throw<Validation.DomainExceptionValidation>();
        }
    }
